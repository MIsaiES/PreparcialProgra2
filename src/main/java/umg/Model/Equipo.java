...
public class Equipo {
    ...
    public Equipo(int idEquipo, String nombre, String pais, String ciudad, String estadio, int fundacion,
                  String entrenador, String webOficial, String facebook, String twitter,
                  String instagram, String patrocinadorPrincipal, Timestamp creadoEn) {
    ...
    public String getPatrocinadorPrincipal() { return patrocinadorPrincipal; }
    public void setPatrocinadorPrincipal(String patrocinadorPrincipal) { this.patrocinadorPrincipal = patrocinadorPrincipal; }
